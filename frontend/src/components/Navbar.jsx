...
import { getUser, loginUser, logoutUser } from "@/utils/auth";
...
const Navbar = () => {
    ...
    return (
        <div className="w-full flex items-center justify-between p-5 bg-transparent">
            ...
            {open && (
                <div className="absolute top-20 left-0 w-full bg-black/40 backdrop-blur-md p-5 flex flex-col gap-5 md:hidden">
                    <Input type="search" placeholder="Search Product" />
